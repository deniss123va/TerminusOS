...
# ==================================
# Общий шаблон: pusha, push $INT_NO, call isr_handler, pop %eax, popa, add $4, %esp, iret
...
# IRQs (32-47)
# ==================================
# Общий шаблон: push $0, pusha, push $INT_NO, call irq_handler, pop %eax, popa, add $4, %esp, iret
